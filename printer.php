	...
	<body>
		...
		<div class="container">
			<div class="row">
				...
				<div class="con">
					<?
					echo "<a href='reports/printer.php' class='boton'>CSV REPORT (Printer)</a>";
					?>
				</div>
		</div>
        ...
        <div class="row">
			...
			FROM
				WhoopIT.employee AS e
					INNER JOIN
				WhoopIT.material AS m ON m.id_employee = e.id_employee where substr(equipo, 1, 5)='Print'
