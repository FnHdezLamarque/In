		...
		<div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form id="material" name="material" method="POST" action="save_main.php" autocomplete="off">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="0" name="state">Aspirado Interno <br>
                            <input class="form-check-input" type="checkbox" value="0" name="state">Archivos <br>
                            <input class="form-check-input" type="checkbox" value="0" name="state">Actualizaciones <br>
                        </div>
