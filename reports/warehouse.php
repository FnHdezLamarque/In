<?
    ...
    header("Content-Disposition: attachment; filename=reporte_warehouse.xls");
?>
...
<table>
    ...
    <?
        ...
        WhoopIT.employee AS e
            INNER JOIN
        WhoopIT.material AS m ON m.id_employee = e.id_employee WHERE SUBSTR(area, 1, 9) = 'Warehouse'
        ORDER BY area ASC;";
