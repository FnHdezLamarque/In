<?
    ...
    header("Content-Disposition: attachment; filename=reporte_mezzanine.xls");
?>
...
<table>
    ...
    <?
        ...
        WhoopIT.employee AS e
            INNER JOIN
        WhoopIT.material AS m ON m.id_employee = e.id_employee WHERE SUBSTR(area, 1, 9) = 'Mezzanine'
        ORDER BY area ASC;";
