<?
    ...
    header("Content-Disposition: attachment; filename=reporte_printer.xls");
?>
...
<table>
    ...
    <?
        ...
        WhoopIT.employee AS e
            INNER JOIN
        WhoopIT.material AS m ON m.id_employee = e.id_employee WHERE SUBSTR(equipo, 1, 7) = 'Printer'
        ORDER BY area ASC;";
