<?
    ...
    header("Content-Disposition: attachment; filename=reporte_administrative.xls");
?>
...
<table>
    ...
    <?
        ...
        WhoopIT.employee AS e
            INNER JOIN
        WhoopIT.material AS m ON m.id_employee = e.id_employee WHERE SUBSTR(area, 1, 14) = 'Administrative'
        ORDER BY area ASC;";
