<?
    ...
    header("Content-Disposition: attachment; filename=reporte_scanner.xls");
?>
...
<table>
    ...
    <?
        ...
        WhoopIT.employee AS e
            INNER JOIN
        WhoopIT.material AS m ON m.id_employee = e.id_employee WHERE SUBSTR(equipo, 1, 7) = 'Scanner'
        ORDER BY area ASC;";
