<?
    ...
    header("Content-Disposition: attachment; filename=reporte_display.xls");
?>
...
<table>
    ...
    <?
        ...
        WhoopIT.employee AS e
            INNER JOIN
        WhoopIT.material AS m ON m.id_employee = e.id_employee WHERE SUBSTR(equipo, 1, 7) = 'Display'
        ORDER BY area ASC;";
