<?
    ...
    header("Content-Disposition: attachment; filename=reporte_keyboard.xls");
?>
...
<table>
    ...
    <?
        ...
        WhoopIT.employee AS e
            INNER JOIN
        WhoopIT.material AS m ON m.id_employee = e.id_employee WHERE SUBSTR(equipo, 1, 8) = 'Keyboard'
        ORDER BY area ASC;";
