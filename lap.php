<?php
	...
	$sentencia = "SELECT id_material, equipo, marca, modelo, serie, nombre_pc, area, nombre, fecha, asset, ubicacion, nota FROM WhoopIT.employee as e INNER JOIN WhoopIT.material as m ON m.id_employee = e.id_employee;";
	...
	<body>
		...
		<div class="container">
			<div class="row">
				...
				<div class="con">
					<?
					echo "<a href='reports/laptop.php' class='boton'>CSV REPORT (Laptop)</a>";
					?>
				</div>
		</div>
        ...
        <div class="row">
			<?php
				...
				FROM
					...
					where substr(equipo, 1, 6)='Laptop';";
			?>
