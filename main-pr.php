...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<h1 style=color:#3282b8>Printer Maintenance IT</h1>
			</div>
        ...
        <div class="row">
			...
			AND (Date IS NULL OR Date > DATE_SUB(CURDATE(), INTERVAL 4 MONTH))
			GROUP BY serie
			ORDER BY dias ASC;";
					...
					<table class="table table-dark table-striped">
						...
						<?php
							...
							<td><?php echo $Row['equipo'] ?></td>
								...
								<td><a href="auxpr.php?id_material=<?php echo $Row['id_material']; ?>"class="btn btn-outline-light">
