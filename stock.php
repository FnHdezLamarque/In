	...
	<body>
		...
		<script 
			type="text/javascript">
				window.onload=function(){
					document.getElementById("op7").style.background='white';
		...
		<div class="container">
			<div class="row">
				...
				<div class="con">
					<?
					echo "<a href='reports/stock.php' class='boton'>CSV REPORT (Stock)</a>";
					?>
				</div>
			<div>
	...
	<div class="container">
        <div class="row">
			<?php
				...
				$query = "SELECT * FROM WhoopIT.material where substr(area, 1, 5)='Stock'
