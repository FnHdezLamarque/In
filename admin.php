	...
	<body>
		...
		<div class="container">
			...
			<style> 
				...
				<div class="con">
					<?
					echo "<a href='reports/administrative.php' class='boton'>CSV REPORT (Administrative)</a>";
					?>
				</div>
	...
	<div class="container">
        <div class="row">
			<?php
				...
				$query = "SELECT * FROM WhoopIT.material WHERE SUBSTR(area, 1, 14) = 'Administrative'
				ORDER BY area ASC;";
